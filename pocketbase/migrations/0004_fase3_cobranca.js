...
migrate(
  (app) => {
    ...
    // --- mensalidades: boletos recorrentes (SPEC-3-001) ---
    ...
    // --- lembretes_cobranca: fila de envio de lembretes (SPEC-3-002) ---
    ...
    // --- conciliacao_bancaria: conciliação de extrato (SPEC-3-003) ---
