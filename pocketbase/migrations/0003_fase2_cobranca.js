// Fase 2 — Cobrança e conciliação: mensalidades recorrentes + conciliação bancária
migrate(
  (app) => {
    const matriculasId = app.findCollectionByNameOrId('matriculas').id

    // --- mensalidades: boletos recorrentes ---
    ...
    // --- conciliacao_bancaria: registros de conciliação ---
    const conciliacao = new Collection({
